-- Update the stored procedures to match the new unique constraints introduced in V13 (tenant)
-- Since we are moving towards tenant-specific schemas, unique constraints no longer include tenant_id.
